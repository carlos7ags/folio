...
// Width tables for the standard 14 PDF fonts.
// Values are in units of 1/1000 of text space (as per PDF spec Appendix D).
// Source: Adobe Font Metrics (AFM) files for the standard 14 fonts.
...
// helveticaWidths — Helvetica (and Helvetica-Oblique) character widths.
var helveticaWidths = map[rune]int{
	...
	'\u2013': 556,  // en dash
	'\u2014': 1000, // em dash
	'\u2018': 222,  // left single quote
	'\u2019': 222,  // right single quote
	'\u201c': 333,  // left double quote
...
// timesRomanWidths — Times-Roman character widths.
...
// timesBoldWidths — Times-Bold character widths.
...
// timesItalicWidths — Times-Italic character widths.
...
// timesBoldItalicWidths — Times-BoldItalic character widths.
